...
wget https://github.com/Zyten/Termux-ADB/raw/master/bin/adb -P $downpath/ -q
echo -e "\e[32m[*] \e[34mDownloading binaries..."
wget https://github.com/Zyten/Termux-ADB/raw/master/bin/adb.bin -P $downpath/ -q
wget https://github.com/Zyten/Termux-ADB/raw/master/bin/fastboot -P $downpath/ -q
wget https://github.com/Zyten/Termux-ADB/raw/master/bin/fastboot-armeabi -P $downpath/ -q
